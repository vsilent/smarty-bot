...
class Reaction:
    """remind me each ...  reaction"""
    response = ''
    request = ''

    def __str__(self):
        return 'Remind me each ... reaction'
    ...
    def run(self):
        ...
        req = self.request.replace('remind me each', '', 1)
        #r = re.compile(re.escape('remind me each'), re.IGNORECASE)
        #req = r.sub('', request)
        ...
        if dow:
            ...
            if req.strip().startswith('at '):
                ################################################
                #   each monday/tuesday/wednesday at 00:00
                ################################################
                ...
                ################################################
                #   each monday/tuesday/wednesday hourly
                ################################################
            ...
            ################################################
            #   each monday/tuesday/wednesday from 00:00 to 00:00
            ################################################
            elif not skip_other:
                #@todo
                ...
                if time and time.group(1):
                    ...
                    #todo each minute, every 5 minutes
