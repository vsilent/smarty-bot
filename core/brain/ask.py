...
"""start brain ask machine listener, which listens to a brain connector socket"""
context = zmq.Context()
sock = context.socket(zmq.REP)
sock.bind( 'ipc:///tmp/smarty-brain' )
empty = {'text': 'sorry did not get what you mean', 'jmsg': "sorry I didn't get", 'type': 'response'}
