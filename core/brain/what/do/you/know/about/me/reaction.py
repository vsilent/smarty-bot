...
class Reaction:
    ...
    def run(self):
        ...
        if profile:
            ...
            .filter_by(uuid=profile.uuid).one()
        ...
        if full_profile:
            ...
            response = 'You are known as %s. But it would be realy nice if you present yourself :). What is you real name ?' % email
...
#r = Reaction(**{'req_obj':{'request': '', 'from' : '','sender': 'vasilii.pascal@gmail.com' }})
#r.run()
