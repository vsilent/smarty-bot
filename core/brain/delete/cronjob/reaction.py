...
class Reaction:
    ...
    def run(self):
        ...
        if all:
            ...
            response = 'hmm, I could not find any of your cronjobs, \
            if you are sure there were I can report a bug, should  \
            I report a bug to developers ? (y/n)'
    ...
    def on_continue(self, msg):
        ...
        if error:
            if agree(request):
                ...
                response += 'by the way, you can add a reminder with \
                command: *remind me every day  \
                at 10:00 with message "Do not forget to drink coffee"* '
            else:
                response = 'ok'
                response += ' by the way, you can add a reminder with \
                command: *remind me every day at 10:00 with message  \
                "Do not forget to drink coffee"* '
