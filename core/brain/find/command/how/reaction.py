...
#
#     def run(self):
#         """default method that executes
#         by /core/brain/main.py and receives request string"""
...
#             todo = {'say': "IT'S, %d O'CLOCK AND %d MINUTES" % (int(hours),
#                      int(minutes)),
#                     'text': fulldate}
#
#         self.response = todo
...
#  Please, describe what functionality your extension
#  provides in __str__ method
#  Comment your code
#  ============================================================================
